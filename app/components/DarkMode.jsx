...
function DarkMode() {
    return (
        <div>
            <button className=" w-20 absolute flex top-3 right-20 shadow-lg shadow-sky-700 bg-sky-700 dark:bg-slate-500 dark:shadow-slate-500 border-2 rounded-full" onClick={setDarkMode}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="rounded-full w-9 h-9 fill-yellow-300 bg-sky-300 transform dark:translate-x-full dark:bg-slate-600 duration-300 ease-in-out">
