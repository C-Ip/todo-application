    ...
    return (
        <div>
            <button className=" w-20 absolute flex top-3 right-20 shadow-lg shadow-slate-700 bg-[#619cb8] dark:bg-[#5272a3] dark:shadow-slate-500 border-2 rounded-full" onClick={setDarkMode}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="rounded-full w-9 h-9 fill-yellow-100 bg-[#b1cddf] transform dark:translate-x-full dark:bg-[#32546c] duration-300 ease-in-out">
                    ...
                    <path className=" fill-[#b1cddf] invisible dark:visible transition-transform ease-in-out" strokeLinecap="round" strokeLinejoin="round" d="M21.752 15.002A9.718 9.718 0 0118 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 003 11.25C3 16.635 7.365 21 12.75 21a9.753 9.753 0 009.002-5.998z" />
                    <path className="fill-[#b1cddf] invisible dark:visible transition-transform ease-in-out" fillRule="evenodd" clipRule="evenodd" d="M17 3a1 1 0 0 1 1 1 2 2 0 0 0 2 2 1 1 0 1 1 0 2 2 2 0 0 0-2 2 1 1 0 1 1-2 0 2 2 0 0 0-2-2 1 1 0 1 1 0-2 2 2 0 0 0 2-2 1 1 0 0 1 1-1Z"></path>
                </svg>
            </button>
        </div>
    )
